            ...
            <form onSubmit={(e) => {
              ...
              <Grid container  item xs={12}>
                <Grid style={{marginBottom:"0.6rem"}}  items xs={6} md={6}>
                  <TextField
                    fullWidth
                    placeholder="encuentra cerca de tu ciudad"
                    name="name"
                    size="small"
                    type="text"
                    variant="outlined"
                ...
                <Grid>
                  <Button color="secondary" variant="contained" type="submit"> buscar</Button>
                </Grid>
            ...
            />
              ...
              <Grid justifyContent="flex-start" container>
                <Grid item md={6} xs={6} style={{marginTop:"0.4rem", marginRight:"0.4rem"}} >
                  <Typography align="center" style={{marginBottom:"0.6rem"}} variant="h5">tarifa</Typography>
                  <Select
                    value={initialValue}
                  ...
                  >
                     <MenuItem style={{ backgroundColor: "white" }} disabled value="">
                      <Typography color="secondary" variant="h6">Ordena de</Typography>
                    </MenuItem>
                    <MenuItem style={{ backgroundColor: "white" }} value="menor">
                      <Typography  color="secondary" variant="h6">Menor a Mayor</Typography>
                    </MenuItem>
                    <MenuItem style={{ backgroundColor: "white" }} value="mayor">
                      <Typography color="secondary" variant="h6">Mayor a Menor</Typography>
                    </MenuItem>
                  </Select>
                </Grid>
              </Grid>
